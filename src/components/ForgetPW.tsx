    ...
    return (
        <div className="flex justify-center items-center h-screen bg-amber-600">
            ...
            <form
                ...
                <br />
                {error && <div className="text-red-500 text-center font-bold mb-4" style={{ fontFamily: "'Montserrat', serif" }}>{error}</div>}
                {success && <div className="text-green-600 text-center font-bold mb-4" style={{ fontFamily: "'Montserrat', serif" }}>{success}</div>}
                <input
                    type="email"
                    name="email"
                    placeholder="Email"
